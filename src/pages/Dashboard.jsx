...
import { LayoutDashboard, Code2, Building2, FileText, BarChart3, Bell, Moon, Sun, Settings, LogOut, User, Menu, X } from "lucide-react";
          ...
          <header className="sticky top-0 z-30 border-b border-slate-800/60 bg-slate-950/70 backdrop-blur">
            <div className="mx-auto max-w-7xl flex items-center justify-between px-4 py-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <button className="relative rounded-lg border border-slate-800 bg-slate-900 p-2 hover:bg-slate-800">
                  <Bell size={18} />
                  <span className="absolute -right-1 -top-1 h-4 w-4 rounded-full bg-indigo-600 text-[10px] grid place-content-center">
                    3
                  </span>
                </button>
              </div>
